...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 flex gap-8 lg:max-w-2xl w-full">
        <form action="/buku" id="form-buku" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4 w-full">
            ...
            <div class="flex flex-col gap-2">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Deskripsi Buku"
            ...
            <div class="flex flex-col gap-2">
                ...
                <input type="file" id="cover" name="cover" placeholder="Cover Buku" class="hidden" accept="image/*"
    ...
    <script>
        ...
        formBuku.addEventListener("submit", () => {
            ...
            if (!judul || !penulis || !deskripsi || !cover) {
